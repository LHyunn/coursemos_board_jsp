...
<center>
    ...
    %>
    <form action="updateAction.jsp?num=<%=num%>" method=post class="form-horizontal" autocomplete="no" style=    "box-sizing: border-box;                                                                                                                                                     ">
        <div class="well" >
            <div class="form-group">
                <label class="control-label col-xs-2" for="subject" >제목</label>
                <div class="col-xs-10" style="">
                    <input required type="text" name="subject" id="subject" class="required subject form-control" placeholder="제목" value="<%=bean.getSubject()%>" autocomplete="no" style="width:626px;float: left;">
                    <input type="hidden" name="writer" id="writer" value="<%=bean.getWriter()%>">
                    <input type="hidden" name="reg_date" id="reg_date" value="<%=strdate%>">
                    <input type="hidden" name="readcount" id="readcount" value="<%=bean.getReadcount()%>">
